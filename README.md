...
> 
> The variable `AtmForc` was generated using the function <span style="color:green;">**get_era5_forcing.m**</span>. If you intend to use a different atmospheric dataset, you must **modify or replace** this function accordingly. Ensure that the resulting `AtmForc` strictly adheres to the required format described above.
